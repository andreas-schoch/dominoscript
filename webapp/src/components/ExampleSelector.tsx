...
export const ExampleSelector: Component<{selected: Accessor<string>, setSelected: Setter<string>}> = props => {
  ...
  return (
    <select onChange={e => props.setSelected(e.currentTarget.value)} class="appearance-none text-white h-full border-b border-stone-600 hover:border-stone-500 focus:outline-none bg-transparent hover:cursor-pointer min-w-28 mr-10 px-3">
